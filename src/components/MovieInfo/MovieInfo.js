...
const MovieInfo = () => {
  ...
  const { movie, credits, reviews, status, error } = useSelector(
    (state) => state.movies
  );
  ...
  const averageVoteDividedByTwo = vote_average / 2;
        ...
        <div className={styles.movieBlock}>
          ...
          <div className={styles.movieData}>
            ...
            <h4 className={styles.genresBlock}>
              ...
              {genres &&
                genres.map((genre, index) => (
                  <GenreBadge key={genre.id} index={index} genre={genre} />
                ))}
            </h4>
            ...
            <h4 className={styles.star}>
              ...
              <Rating
                defaultValue={averageVoteDividedByTwo}
                precision={0.05}
                readOnly
              />
            </h4>
